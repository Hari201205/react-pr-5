...
import './home.css'
import slider from '../assets/img/bg.jpg';

const Home = () => {
    return (
        <div className="col-lg-12 slider d-flex justify-content-center">
            <div className="text-light pt-4 pb-4 col-lg-9 georgia d-flex justify-content-between  align-item-center">
                <div className="slider-contant p-5">
                    ...
                    <div className="slider-btn col-lg-6 verdana pt-5 d-flex">
